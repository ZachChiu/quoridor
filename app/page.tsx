            ...
            <div className="relative flex size-full flex-col items-center justify-center gap-8 rounded-xl border-4 border-gray-900 bg-tertiary p-8 text-xl md:gap-12">
              ...
              <div className="flex flex-col gap-4">
                <SectionShadow>
                  <Link
                    href="/play"
                    className="relative block w-full rounded-xl border-4 border-gray-900 bg-tertiary-500 p-4 text-xl hover:-translate-x-0.5 hover:-translate-y-0.5 focus:translate-x-1 focus:translate-y-1"
