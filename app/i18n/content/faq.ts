...
export const FAQ_TEXT: Record<Locale, FaqItem[]> = {
  ...
  'zh-Hans': [
    { q: '墙壁围棋和围棋有什么不同？',
      a: '墙壁围棋是围棋的变体，目标一样是圈地，但手段完全不同。围棋是 19×19，落子后就不能动，靠棋子之间的连接围地；墙壁围棋是 7×7，棋子**每回合都会动**，围地靠的是墙而不是棋子。另外它没有提子，也没有打劫 —— 一道墙放下去就不会消失（三人局的破墙每人整局限一次）。规则少得多，一局大约十分钟。' },
    { q: '墙壁围棋出自哪里？',
      a: '出自 Netflix 真人秀《魔鬼的计谋：死亡密室》。它是节目里的对决项目之一，规则简单但变化很多，播出后不少人在找在线版。' },
    { q: '一个人可以玩吗？',
      a: '可以，有人机对战模式，电脑对手分三级。电脑会算出每一格谁先走得到（Voronoi 划分）再决定怎么下，不是随机乱走。' },
    { q: '需要下载或注册吗？',
      a: '都不用。打开网页就能玩，本地对战和人机对战完全可以离线玩。联机对战会用匿名身份创建房间，把链接发给朋友就能一起玩，同样不需要注册。' },
    { q: '几个人可以玩？',
      a: '2 人或 3 人。两人局每人 4 枚棋子，三人局每人 2 枚。三人局多一个“破墙”机制，每人整局限用一次，可以拆掉一道已经存在的墙。' },
    { q: '轮到我但棋子动不了怎么办？',
      a: '系统会自动跳过。当你所有棋子都被封在自己的地盘里、做什么都不会改变结果时，这一回合会直接交给下一位。所有棋子都被封住时游戏结束，开始计分。' },
  ],
  th: [
    { q: 'Wall Go ต่างจากหมากล้อมอย่างไร?',
      a: 'Wall Go ดัดแปลงมาจากหมากล้อม เป้าหมายยังเป็นการล้อมพื้นที่ แต่วิธีต่างกันมาก หมากล้อมเล่นบนกระดาน 19×19 วางหมากแล้วเดินไม่ได้ และล้อมพื้นที่ด้วยการเชื่อมหมากเข้าหากัน ส่วน Wall Go เล่นบนกระดาน 7×7 หมาก**เดินได้ทุกตา** และล้อมพื้นที่ด้วยกำแพงแทนตัวหมาก นอกจากนี้ยังไม่มีการกินหมากและไม่มีโคะ กำแพงที่สร้างแล้วจะอยู่ถาวร (ยกเว้นการทำลายกำแพงในเกม 3 คนที่ทำได้คนละครั้ง) กติกาน้อยกว่ามาก เล่นจบในราว 10 นาที' },
    { q: 'Wall Go มาจากไหน?',
      a: "มาจากรายการเรียลลิตี้ของ Netflix เรื่อง The Devil's Plan: Death Room ซึ่งใช้เป็นหนึ่งในเกมประลอง กติกาง่ายแต่พลิกแพลงได้มาก หลังออกอากาศจึงมีคนตามหาเวอร์ชันออนไลน์กันเยอะ" },
    { q: 'เล่นคนเดียวได้ไหม?',
      a: 'ได้ มีโหมดเล่นกับคอมพิวเตอร์ 3 ระดับ คอมพิวเตอร์จะคำนวณว่าแต่ละช่องใครไปถึงก่อน (การแบ่งแบบ Voronoi) แล้วจึงตัดสินใจเดิน ไม่ได้เดินแบบสุ่ม' },
    { q: 'ต้องดาวน์โหลดหรือสมัครสมาชิกไหม?',
      a: 'ไม่ต้องเลย เปิดเว็บก็เล่นได้ทันที โหมดเล่นเครื่องเดียวและเล่นกับคอมพิวเตอร์เล่นแบบออฟไลน์ได้ ส่วนโหมดออนไลน์จะสร้างห้องด้วยตัวตนแบบไม่ระบุชื่อ แค่ส่งลิงก์ให้เพื่อนก็เล่นด้วยกันได้ ไม่ต้องสมัครเช่นกัน' },
    { q: 'เล่นได้กี่คน?',
      a: 'เล่นได้ 2 หรือ 3 คน เกม 2 คนมีหมากคนละ 4 ตัว เกม 3 คนมีคนละ 2 ตัว และเกม 3 คนมีกติกา “ทำลายกำแพง” เพิ่มเข้ามา ใช้ได้คนละครั้งตลอดเกม เพื่อรื้อกำแพงที่มีอยู่แล้วหนึ่งด้าน' },
    { q: 'ถ้าถึงตาเราแต่หมากเดินไม่ได้ ต้องทำอย่างไร?',
      a: 'ระบบจะข้ามให้อัตโนมัติ เมื่อหมากทุกตัวของคุณถูกล้อมอยู่ในพื้นที่ของตัวเอง และไม่ว่าทำอะไรก็ไม่เปลี่ยนผล ตาจะถูกส่งต่อให้คนถัดไปทันที เมื่อหมากทุกตัวถูกล้อมหมด เกมจะจบและเริ่มนับคะแนน' },
  ],
};
