...
export const STEP_TEXT: Record<Locale, StepText[]> = {
  ...
  'zh-Hans': [
    { title: '目标：围出最大的地盘',
      body: '用墙把一块区域围起来。区域里只有你的棋子时，这块地就算你的。\n所有棋子都被围住后开始计分，格数最多的人获胜。' },
    { title: '开局：先把棋子放上棋盘',
      body: '两人：每人 4 枚。其中 2 枚一开始就在棋盘上，剩下 2 枚按“红、蓝、蓝、红”的顺序轮流放。\n三人：每人 2 枚，全部自己放。\n\n灰点是可以放的位置。' },
    { title: '移动：走 0 到 2 格',
      body: '选一枚自己的棋子，往上下左右走 0 到 2 格。两格可以走直线，也可以拐弯。\n灰点是能走到的地方。不想动就走 0 格。' },
    { title: '筑墙：走完一定要筑一道',
      body: '移动结束后，在这枚棋子的四条边里挑一边筑墙。这一步不能跳过。\n半透明的短线就是可以筑墙的四个位置。' },
    { title: '墙挡住所有人',
      body: '墙不分是谁筑的，对所有人都有效，包括你自己。\n围住自己地盘的那道墙，也可能把自己的路堵死。棋盘外围也算一圈墙。' },
    { title: '圈地：里面只能有你的棋子',
      body: '一块区域被墙完全围住，而且里面只有你的棋子，整块就算你的。\n里面没有棋子，或者同时有别人的棋子，就是中立区，不算任何人的分。' },
    { title: '破墙：只有三人局才有',
      body: '三人：每人整局可以拆掉一道墙，只能用一次。要拆的墙必须在自己棋子旁边，拆掉后这枚棋子可以继续走。\n锤子标记就是可以拆的墙。\n\n两人：没有这条规则。' },
    { title: '结束与计分',
      body: '所有棋子都被围在各自的区域里时，游戏结束。\n地盘格数最多的人获胜，同分并列。' },
  ],
  th: [
    { title: 'เป้าหมาย: ล้อมพื้นที่ให้ได้มากที่สุด',
      body: 'ใช้กำแพงล้อมพื้นที่หนึ่งไว้ ถ้าในพื้นที่นั้นมีแต่หมากของคุณ พื้นที่นั้นจะนับเป็นของคุณ\nเมื่อหมากทุกตัวถูกล้อมหมดแล้วจึงเริ่มนับคะแนน ใครได้จำนวนช่องมากที่สุดชนะ' },
    { title: 'เริ่มเกม: วางหมากลงกระดาน',
      body: '2 คน: คนละ 4 ตัว โดย 2 ตัวอยู่บนกระดานตั้งแต่แรก อีก 2 ตัวผลัดกันวางตามลำดับ แดง น้ำเงิน น้ำเงิน แดง\n3 คน: คนละ 2 ตัว วางเองทั้งหมด\n\nจุดสีเทาคือตำแหน่งที่วางได้' },
    { title: 'การเดิน: 0 ถึง 2 ช่อง',
      body: 'เลือกหมากของคุณหนึ่งตัว แล้วเดินขึ้น ลง ซ้าย หรือขวา 0 ถึง 2 ช่อง สองช่องจะเดินตรงหรือเลี้ยวก็ได้\nจุดสีเทาคือช่องที่เดินไปถึงได้ ถ้าไม่อยากเดินก็เดิน 0 ช่อง' },
    { title: 'กำแพง: เดินเสร็จต้องสร้างหนึ่งด้าน',
      body: 'เมื่อเดินเสร็จ ให้เลือกสร้างกำแพงหนึ่งด้านจากสี่ด้านรอบช่องของหมากตัวนั้น ขั้นนี้ข้ามไม่ได้\nขีดสั้นจาง ๆ คือสี่ตำแหน่งที่สร้างกำแพงได้' },
    { title: 'กำแพงกั้นทุกคน',
      body: 'กำแพงไม่แบ่งว่าใครสร้าง กั้นผู้เล่นทุกคนรวมถึงตัวคุณเองด้วย\nกำแพงที่ล้อมพื้นที่ของคุณอาจปิดทางของคุณเองด้วย ขอบกระดานนับเป็นกำแพงรอบหนึ่ง' },
    { title: 'ล้อมพื้นที่: ข้างในต้องมีแต่หมากของคุณ',
      body: 'พื้นที่ที่ถูกกำแพงล้อมไว้ทั้งหมด และข้างในมีแต่หมากของคุณ จะนับเป็นของคุณทั้งผืน\nถ้าข้างในไม่มีหมาก หรือมีหมากของคนอื่นปนอยู่ จะเป็นพื้นที่กลาง ไม่นับคะแนนให้ใคร' },
    { title: 'ทำลายกำแพง: มีเฉพาะเกม 3 คน',
      body: '3 คน: แต่ละคนทำลายกำแพงได้หนึ่งด้าน ใช้ได้ครั้งเดียวตลอดเกม กำแพงที่จะทำลายต้องอยู่ติดกับหมากของคุณ และหลังทำลายแล้วหมากตัวนั้นเดินต่อได้\nสัญลักษณ์ค้อนคือกำแพงที่ทำลายได้\n\n2 คน: ไม่มีกติกานี้' },
    { title: 'จบเกมและนับคะแนน',
      body: 'เกมจบเมื่อหมากทุกตัวถูกล้อมอยู่ในพื้นที่ของตัวเอง\nใครมีพื้นที่มากที่สุดชนะ ถ้าคะแนนเท่ากันถือว่าชนะร่วมกัน' },
  ],
};
