 ...
 */
const LEVELS: { key: Difficulty; label: string; tone: string }[] = [
  { key: 'easy', label: '一級', tone: 'bg-tile-forest text-tile-cream' },
  { key: 'normal', label: '二級', tone: 'bg-tile-amber text-tile-ink' },
  { key: 'hard', label: '三級', tone: 'bg-tile-red text-tile-cream' },
];
  ...
  return (
    <div className="flex w-full max-w-[380px] flex-col items-center gap-6 px-5">
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <h2 className="text-3xl font-black tracking-tight">選一個難度</h2>
      </div>
