  ...
  return (
    <>
      <button
        ...
        className="relative grid size-10 place-items-center rounded-full bg-tile-ink/[0.06] text-xl text-ink-soft transition after:absolute after:-inset-0.5 after:content-[''] hover:bg-tile-ink/[0.12] active:scale-95"
      >
